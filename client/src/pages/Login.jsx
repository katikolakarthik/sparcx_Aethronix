      ...
      <div className="mx-auto flex max-w-lg flex-col px-4 py-12">
        ...
        >
          <div className="mb-6 flex items-center gap-2">
            ...
            <div>
              <h1 className="font-display text-2xl font-bold text-slate-900 dark:text-white">Login</h1>
              <p className="text-sm text-slate-500">Access your simulations</p>
            </div>
          </div>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            New here?{' '}
            <Link to="/register" className="font-semibold text-farm-700 hover:underline dark:text-farm-400">
              Create an account
            </Link>
          </p>
        </motion.div>
